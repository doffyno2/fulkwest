---
title: "What Does PNR Means in Air Travel Booking Reference?"
description: ""
date: 2022-04-15
categories: 
tags: 
thumbnail: https://tse1.mm.bing.net/th?q=What%20Does%20Pnr%20Means%20In%20Air%20Travel%20Booking%20Reference%3F&w=800&h=500&c=1&rs=1
author: "Osgood"
showToc: true
TocOpen: true
draft: false
...
<center>
	<img src="https://tse1.mm.bing.net/th?q=What%20Does%20Pnr%20Means%20In%20Air%20Travel%20Booking%20Reference%3F&w=800&h=500&c=1&rs=1" alt="What Does Pnr Means In Air Travel Booking Reference?" width="800" height="500" style="display: block; width: 100%; height: auto">
</center>

<p>Air travel booking reference, or PNR (Passenger Name Record), is a record in the database of a computer reservation system (CRS) that contains the itinerary for a passenger, or a group of passengers traveling together. PNR is a unique identifier that is assigned to each booking, and it contains all the details of a traveler’s journey, including their name, contact details, dates of travel, destination, ticket type, and any other relevant information.</p>

<h2>What Is a PNR Number?</h2>

<p>A PNR number is a unique 6-digit alphanumeric code that is assigned to each booking. The code is used to identify the passenger and their booking information in the CRS. A PNR number can be used for both domestic and international travel. It is important to note that the PNR number is not the same as the ticket number. The ticket number is issued by the airline after the purchase of the ticket. The PNR number is used to identify the booking in the CRS.</p>

<h2>What Is the Purpose of a PNR Number?</h2>

<p>The main purpose of a PNR number is to track and store information about the passenger’s journey. The PNR number enables the airline staff to access the booking information in the CRS and make any necessary changes to the booking. The PNR number also allows the airline to track the passenger’s journey, including the route taken and any stops made along the way. Additionally, the PNR number can be used to identify the passenger and their booking information in the case of a lost ticket or a baggage issue.</p>

<h2>How Do I Find My PNR Number?</h2>
...
<h3>Can I Change My PNR Number?</h3>
