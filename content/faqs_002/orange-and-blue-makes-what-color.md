...
<h2>How to Mix Orange and Blue to Create the Perfect Color Combination</h2>
...
<h3>What colors can be mixed with orange and blue to create an interesting color palette?</h3>
