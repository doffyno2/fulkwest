...
Although the formula for converting between inches and centimeters is relatively straightforward, it can be difficult to remember. To make things easier, you should remember the following two tips: 
